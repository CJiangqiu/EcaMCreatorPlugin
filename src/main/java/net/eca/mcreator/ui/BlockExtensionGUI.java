...
public class BlockExtensionGUI extends ModElementGUI<BlockExtensionElement> {
    ...
    private TextureHolder maskTexture;
    ...
    protected void initGUI() {
        ...
        maskTexture = new TextureHolder(new TypedTextureSelectorDialog(mcreator, TextureType.BLOCK), 32);
    ...
    public BlockExtensionElement getElementFromGUI() {
        ...
        element.maskTexture = maskTexture.getID();
